# This file was generated by the {rix} R package v0.14.3 on 2025-02-04
# with following call:
# >rix(date = "2025-01-14",
#  > r_pkgs = c("svglite",
#  > "tidyverse",
  ...
  rpkgs = builtins.attrValues {
    ...
    webgazer = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "542c8cec5e64bd03decb8f0694816cba16d9a90d";
        sha256 = "sha256-748pbPgi/eKaj33N1CITSUFHY/CyDj/exQ/NTqMJE0s=";
      };
