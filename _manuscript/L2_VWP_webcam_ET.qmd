...
```{r}
#| label: fig-sankey
#| fig-cap: Participant flow through the  experiment 
#| echo: false
...
oob_data_L2 %>%
  flextable() %>%
  theme_apa() %>%
  save_as_image(here::here("_manuscript","Figures", "oob_data_L2.png"), exapnd=10, res=300)
...
aoi_loc %>% 
  flextable() %>% 
  save_as_image(here::here("_manuscript","Figures", "aoi-quad.png"), res=300)
...
gaze_sub_L2 %>%
  head() %>%
  flextable() %>%
  save_as_image(here::here("_manuscript","Figures", "downsample_table.png"), res=300)
