...
library(knitr)
opts_chunk$set(fig.align='center', size="small", tidy.opts=list(width.cutoff=50), tidy=TRUE)
...
One method, manual eye-tracking [@trueswell2008], involves using video recordings of participants, which can be collected through online teleconferencing platforms such as Zoom (www.zoom.com). Here eye gaze (direction) is manually analyzed posthoc frame by frame from these recordings.
...
required_packages <- c(
  ...
  "formatR"    # better looking code chunks
)
